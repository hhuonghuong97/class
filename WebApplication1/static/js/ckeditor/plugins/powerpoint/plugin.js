...
function isPowerpointFile(fileName) {
    ...
    if (ext == "pptx" || ext == "ppt") {
        ...
        alert("Vui lòng chọn file power point");
        return false;
    }
    return true;
}
...
CKEDITOR.plugins.add('powerpoint', {
    icons: 'powerpoint',
    init: function (editor) {
        CKEDITOR.dialog.add('powerpointDialog', function (editor) {
            return {
                title: 'Thêm file power point',
                minWidth: 400,
                minHeight: 100,
                contents: [
                    {
                        ...
                        elements: [
                            {
                                type: 'file',
                                id: 'file',
                                validate: CKEDITOR.dialog.validate.notEmpty("Vui lòng chọn file power point"),
        ...
        editor.addCommand('insertPowerpoint', new CKEDITOR.dialogCommand('powerpointDialog'));
        editor.ui.addButton('powerpoint', {
            label: 'Upload power point',
            command: 'insertPowerpoint',
            toolbar: 'insert'
        });
    }
});